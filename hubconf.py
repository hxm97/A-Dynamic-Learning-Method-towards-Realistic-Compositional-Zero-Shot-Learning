...
def dino_vits16(model_root, pretrained=True, **kwargs):
    """
    ...
    if pretrained:
        state_dict = torch.load(os.path.join(model_root, 'dino_deitsmall16_pretrain.pth'))
...
def dino_vits8(model_root, pretrained=True, **kwargs):
    """
    ...
    if pretrained:
        state_dict = torch.load(os.path.join(model_root, 'dino_deitsmall8_pretrain.pth'))
...
def dino_vitb16(model_root, pretrained=True, **kwargs):
    """
    ...
    if pretrained:
        state_dict = torch.load(os.path.join(model_root, 'dino_vitbase16_pretrain.pth'))
...
def dino_vitb8(model_root, pretrained=True, **kwargs):
    """
    ...
    if pretrained:
        state_dict = torch.load(os.path.join(model_root, 'dino_vitbase8_pretrain.pth'))
...
def dino_resnet50(model_root, pretrained=True, **kwargs):
    """
    ...
    if pretrained:
        state_dict = torch.load(os.path.join(model_root, 'dino_resnet50_pretrain.pth'))
